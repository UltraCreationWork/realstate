...
class Header(models.Model):
    ...
    content = models.CharField(max_length=500,verbose_name="Content Box",blank=True)
...
class Aboutus(models.Model):
    ...
    paragraph = models.CharField(max_length=300,verbose_name="Main Paragrph",blank=True)
    point_1 = models.CharField(max_length=150,verbose_name="Point one",blank=True)
    point_2 = models.CharField(max_length=150,verbose_name="Point two",blank=True)
    point_3 = models.CharField(max_length=150,verbose_name="Point three",blank=True)
...
class Feature(models.Model):
    ...
    point_2 = models.CharField(max_length=150,verbose_name="Point two",blank=True)
    point_3 = models.CharField(max_length=150,verbose_name="Point three",blank=True)
    point_4 = models.CharField(max_length=150,verbose_name="Point Four",blank=True)
    point_5 = models.CharField(max_length=150,verbose_name="Point Five",blank=True)
    point_6 = models.CharField(max_length=150,verbose_name="Point Six",blank=True)
    point_7 = models.CharField(max_length=150,verbose_name="Point Seven",blank=True)
    point_8 = models.CharField(max_length=150,verbose_name="Point Eight",blank=True)
    point_9 = models.CharField(max_length=150,verbose_name="Point Nine",blank=True)
    point_10 = models.CharField(max_length=150,verbose_name="Point Ten",blank=True)
    point_11 = models.CharField(max_length=150,verbose_name="Point Eleven",blank=True)
    point_12 = models.CharField(max_length=150,verbose_name="Point Twele",blank=True)
    point_13 = models.CharField(max_length=150,verbose_name="Point Thirteen",blank=True)
    point_14 = models.CharField(max_length=150,verbose_name="Point Fourteen",blank=True)
    point_15 = models.CharField(max_length=150,verbose_name="Point Fifteen",blank=True)
...
class Price(models.Model):
    ...
    title = models.CharField(max_length=200,verbose_name="Package Name")
...
class Footer(models.Model):
    ...
    paragraph = models.CharField(max_length=150,verbose_name="Content Box")
...
class Career_header(models.Model):
    title = models.CharField(max_length=150,verbose_name="image tittle")
...
class Career(models.Model):
    number = models.PositiveIntegerField(verbose_name="Featur Serial Number")
    icon = models.CharField(max_length=23,verbose_name="Icon")
    title = models.CharField(max_length=200,verbose_name="Post Name")
    img = models.ImageField(upload_to="realestate/feature",verbose_name="Image of Work")
